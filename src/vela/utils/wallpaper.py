...
from vela.utils.hypr import message
from vela.utils.material import get_colours_for_image
...
from vela.utils.scheme import Scheme, get_scheme
from vela.utils.theme import apply_colours
...
def get_smart_opts(wall: Path, cache: Path) -> str:
    ...
    from vela.utils.colorfulness import get_variant
