...
from vela.subcommands import clipboard, emoji, record, resizer, scheme, screenshot, shell, toggle, wallpaper
from vela.utils.paths import wallpapers_dir
from vela.utils.scheme import get_scheme_names, scheme_variants
from vela.utils.wallpaper import get_wallpaper


def parse_args() -> (argparse.ArgumentParser, argparse.Namespace):
    parser = argparse.ArgumentParser(prog="vela", description="Main control tool for the Vela dotfiles")
    ...
    scheme_parser = command_parser.add_parser("scheme", help="manage the color scheme")
